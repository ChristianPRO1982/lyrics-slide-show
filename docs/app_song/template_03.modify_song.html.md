...
- Affiche les actions de page (aperçu, enregistrer, enregistrer et quitter, dévalider si disponible).
...
- Monte les scripts front de réorganisation et de prévisualisation.
