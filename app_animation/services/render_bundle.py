...
def _resolve_style(
    ...
    return ResolvedVisualStyle(
        ...
        horizontal_padding=(
            ...
            else animation_song.horizontal_padding_override or animation.horizontal_padding
        ),
        background_asset_code=(
            ...
            else animation_song.background_asset_code_override or animation.background_asset_code
        ),
    )
