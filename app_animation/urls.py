...
urlpatterns = [
    ...
    path('modify_BG_image_animation/<int:xxx_id>/', views.modify_BG_image_animation, name='modify_BG_image_animation'),
    path('modify_BG_image_song/<int:xxx_id>/', views.modify_BG_image_animation, name='modify_BG_image_song'),
    path('modify_BG_image_verse/<int:xxx_id>/', views.modify_BG_image_animation, name='modify_BG_image_verse'),
