    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "font_family",
                    models.CharField(default="Source Sans Pro", max_length=120),
                ),
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        fields=["scheduled_at"], name="a_animations_sched_idx"
                    ),
                ],
            },
        ),
            ...
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        fields=("animation", "position"),
                        name="a_anim_songs_anim_pos_uniq",
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["animation_song"], name="a_anim_vo_anim_song_idx"
                    ),
                    models.Index(
                        fields=["source_verse_id"], name="a_anim_vo_source_idx"
                    ),
                ],
            },
        ),
