    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "bg_img_ratio_min",
                    models.DecimalField(decimal_places=1, default=1.3, max_digits=3),
                ),
                (
                    "bg_img_ratio_max",
                ...
                (
                    "bg_img_allowed_ext",
                    models.CharField(default=".jpg,.jpeg,.png", max_length=100),
                ),
                (
                    "bg_img_allowed_mime",
                    models.CharField(default="image/jpeg,image/png", max_length=100),
                ),
            ],
            options={
